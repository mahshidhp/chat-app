...
class UserTableMap extends TableMap
{
    ...
    {
        $this->addRelation('Group', '\\Model\\Group', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':creator_id',
    1 => ':id',
        ...
        $this->addRelation('MessageRelatedBySenderId', '\\Model\\Message', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':sender_id',
    1 => ':id',
  ),
), null, null, 'MessagesRelatedBySenderId', false);
        $this->addRelation('MessageRelatedByReceiverId', '\\Model\\Message', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':receiver_id',
    1 => ':id',
  ),
), null, null, 'MessagesRelatedByReceiverId', false);
