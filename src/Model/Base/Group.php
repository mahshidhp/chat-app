...
abstract class Group implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\GroupTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Group object.
     */
    ...
    public function setCreatorId($v)
    {
        ...
        if ($this->creator_id !== $v) {
            $this->creator_id = $v;
            $this->modifiedColumns[GroupTableMap::COL_CREATOR_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupTableMap::translateFieldName('CreatorId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Group'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(GroupTableMap::COL_CREATOR_ID)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(GroupTableMap::COL_CREATOR_ID)) {
            $criteria->add(GroupTableMap::COL_CREATOR_ID, $this->creator_id);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\Group (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Group Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aUser === null && ($this->creator_id != 0)) {
    ...
    public function initMessages(bool $overrideExisting = true): void
    {
        ...
        $this->collMessages->setModel('\Model\Message');
    }
        ...
        if (null === $this->collMessages || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collMessages) {
                    ...
                    $collMessages->setModel('\Model\Message');
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildMessage}> List of ChildMessage objects
     */
    public function getMessagesJoinsenderId(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMessageQuery::create(null, $criteria);
        $query->joinWith('senderId', $joinBehavior);
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildMessage}> List of ChildMessage objects
     */
    public function getMessagesJoinreceiverId(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMessageQuery::create(null, $criteria);
        $query->joinWith('receiverId', $joinBehavior);
    ...
    public function setMemberships(Collection $memberships, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($membershipsToDelete as $membershipRemoved) {
            $membershipRemoved->setGroup(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildMembership}> List of ChildMembership objects
     */
    public function getMembershipsJoinUser(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMembershipQuery::create(null, $criteria);
