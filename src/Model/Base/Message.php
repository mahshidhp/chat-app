...
abstract class Message implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Model\\Map\\MessageTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Message object.
     */
    ...
    public function setSenderId($v)
    {
        ...
        if ($this->sender_id !== $v) {
            $this->sender_id = $v;
            $this->modifiedColumns[MessageTableMap::COL_SENDER_ID] = true;
        }

        if ($this->asenderId !== null && $this->asenderId->getId() !== $v) {
            $this->asenderId = null;
        }
    ...
    public function setReceiverId($v)
    {
        ...
        if ($this->receiver_id !== $v) {
            $this->receiver_id = $v;
            $this->modifiedColumns[MessageTableMap::COL_RECEIVER_ID] = true;
        }

        if ($this->areceiverId !== null && $this->areceiverId->getId() !== $v) {
            $this->areceiverId = null;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[MessageTableMap::COL_GROUP_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MessageTableMap::translateFieldName('SenderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sender_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MessageTableMap::translateFieldName('ReceiverId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receiver_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MessageTableMap::translateFieldName('GroupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MessageTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MessageTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Message'), 0, $e);
        }
    }
    ...
    {
        if ($this->asenderId !== null && $this->sender_id !== $this->asenderId->getId()) {
            $this->asenderId = null;
        }
        if ($this->areceiverId !== null && $this->receiver_id !== $this->areceiverId->getId()) {
            $this->areceiverId = null;
        }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->asenderId !== null) {
                if ($this->asenderId->isModified() || $this->asenderId->isNew()) {
                    $affectedRows += $this->asenderId->save($con);
                }
                $this->setsenderId($this->asenderId);
            }

            if ($this->areceiverId !== null) {
                if ($this->areceiverId->isModified() || $this->areceiverId->isNew()) {
                    $affectedRows += $this->areceiverId->save($con);
                }
                $this->setreceiverId($this->areceiverId);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_SENDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'sender_id';
        }
        if ($this->isColumnModified(MessageTableMap::COL_RECEIVER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'receiver_id';
        }
        if ($this->isColumnModified(MessageTableMap::COL_GROUP_ID)) {
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->asenderId) {
                ...
                $result[$key] = $this->asenderId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->areceiverId) {
                ...
                $result[$key] = $this->areceiverId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aGroup) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_SENDER_ID)) {
            $criteria->add(MessageTableMap::COL_SENDER_ID, $this->sender_id);
        }
        if ($this->isColumnModified(MessageTableMap::COL_RECEIVER_ID)) {
            $criteria->add(MessageTableMap::COL_RECEIVER_ID, $this->receiver_id);
        }
        if ($this->isColumnModified(MessageTableMap::COL_GROUP_ID)) {
            $criteria->add(MessageTableMap::COL_GROUP_ID, $this->group_id);
        }
        if ($this->isColumnModified(MessageTableMap::COL_TEXT)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Model\Message (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Message Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setsenderId(ChildUser $v = null)
    {
        if ($v === null) {
        ...
        if ($v !== null) {
            $v->addMessageRelatedBySenderId($this);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getsenderId(?ConnectionInterface $con = null)
    {
        if ($this->asenderId === null && ($this->sender_id != 0)) {
            $this->asenderId = ChildUserQuery::create()->findPk($this->sender_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->asenderId->addMessagesRelatedBySenderId($this);
             */
        }

        return $this->asenderId;
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setreceiverId(ChildUser $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addMessageRelatedByReceiverId($this);
        }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getreceiverId(?ConnectionInterface $con = null)
    {
        if ($this->areceiverId === null && ($this->receiver_id != 0)) {
            $this->areceiverId = ChildUserQuery::create()->findPk($this->receiver_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->areceiverId->addMessagesRelatedByReceiverId($this);
             */
        }

        return $this->areceiverId;
    }

    /**
     * Declares an association between this object and a ChildGroup object.
     *
     * @param ChildGroup|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildGroup|null The associated ChildGroup object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if (null !== $this->asenderId) {
            $this->asenderId->removeMessageRelatedBySenderId($this);
        }
        if (null !== $this->areceiverId) {
            $this->areceiverId->removeMessageRelatedByReceiverId($this);
        }
        if (null !== $this->aGroup) {
            $this->aGroup->removeMessage($this);
        }
        $this->id = null;
        $this->sender_id = null;
